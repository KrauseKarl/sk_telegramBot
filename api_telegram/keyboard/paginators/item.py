...
from api_telegram import ItemCBD, FavoriteAddCBD, FavoriteAction, Navigation, ReviewAction, ReviewCBD, ImagesAction, \
    ImageCBD, DetailCBD, CacheKey
    ...
    async def create_paginate_buttons(self, page=None):
        if self.api_page == 1 and int(page) == 1:
            ...
            if prev_list is None:
                ...
                prev_list = await cache_key.previous_api_page(self.key, self.api_page - 1)
            prev_paginate_page = len(prev_list)
